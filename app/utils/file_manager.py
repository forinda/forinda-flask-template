...
class FileManager:
    ...
    def save_file(self, file: FileStorage, custom_filename: Optional[str] = None) -> Tuple[bool, str, Optional[Dict]]:
        """
        Save uploaded file.
    ...
    def list_files(self, page: int = 1, limit: int = 20, search: Optional[str] = None) -> Dict:
        """
